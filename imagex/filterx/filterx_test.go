...
var (
	SourcePaths = []string{SourcePath01, SourcePath02, SourcePath03, SourcePath04, SourcePath05, SourcePath06, SourcePath07}
	BlurPaths   = []string{BlurPath01, BlurPath02, BlurPath03, BlurPath04, BlurPath05, BlurPath06, BlurPath07}
	CVTPaths    = []string{CVTPath01, CVTPath02, CVTPath03, CVTPath04, CVTPath05, CVTPath06, CVTPath07}
	DilatePaths = []string{DilatePath01, DilatePath02, DilatePath03, DilatePath04, DilatePath05, DilatePath06, DilatePath07}
	ErodePaths  = []string{ErodePath01, ErodePath02, ErodePath03, ErodePath04, ErodePath05, ErodePath06, ErodePath07}
	GrayPaths   = []string{GrayPath01, GrayPath02, GrayPath03, GrayPath04, GrayPath05, GrayPath06, GrayPath07}
	RGBPaths    = []string{RGBPath01, RGBPath02, RGBPath03, RGBPath04, RGBPath05, RGBPath06, RGBPath07}
)
